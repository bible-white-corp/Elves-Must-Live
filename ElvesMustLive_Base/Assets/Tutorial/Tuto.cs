        ...
        switch (i)
        {
            case 0:
                ...
                label.text = "Welcome to the[99ff00]Elves Must Live tutorial[-] !" +
                    ...
                    "\nPress[99ff00]Enter[-] to continue";//tuto_1
                break;
            case 1:
                if (Input.GetKeyDown(KeyCode.Return))
                {
                    ...
                    label.text = "Good ! I will summon a orc. Be ready to attack him with [99ff00]Left Clic[-] " +
                        "\nPress [99ff00]Enter[-] when you are ready !";//tuto_2
                }
                break;
            case 2:
                if (Input.GetKeyDown(KeyCode.Return))
                {
                    ...
                    label.text = "Kill the orc with [99ff00]Left Clic[-] !!"; //tuto_3
                }
                break;
            case 3:
                if (!game.ennemyInMap)
                {
                    ...
                    label.text = "Good ! You kill a orc and earn 10 gold !" +
                        "\nPress [99ff00]Enter[-] to continue.";//tuto_4
                }
                break;
            case 4:
                ...
                if (Input.GetKeyDown(KeyCode.Return))
                {
                    ...
                    label.text = "You have a 10 of money. You can only buy a [0000ff]Cannon[-]" +
                        "\nPress [99ff00]B[-] to start building a turret.";//tuto_4
                }
                break;
            case 5:
                ...
                {
                    i++;
                    label.text = "Choose an appropriate place to build your [0000ff]Cannon[-] (When the cannon is [99ff00]green[-])" +
                        "\nPress [99ff00]B[-] to place the turret.";//tuto_5
                }
                break;
            case 6:
                if (Input.GetKeyDown(KeyCode.B))
                {
                    ...
                    label.text = "Oups ! 3 orcs are comming ! Dont worry, your cannon will help you !" +
                        "\nAttack the orcs and watch your cannon.";//tuto_6
                }
                break;
            case 7:
                if (GameObject.FindGameObjectWithTag("Shootable") == null)
                {
                    ...
                    label.text = "Good ! You have a lot of money now ! You can buy (or upgrade) other turrets !" +
                        "\nPress [99ff00]V[-] to open the [ff0000]Shop[-].";//tuto7
                }
                break;
            case 8:
                if (Input.GetKeyDown(KeyCode.V))
                {
                    ...
                    label.text = "Fine. Here you can click on a turret, and select Buy to optain it. Be carrefull, you must have sufficient funds." +
                        "\nChoose a turret and buy it !";//tuto_8
                }
                break;
            case 9:
            ...
            case 11:
                if (Input.GetKeyDown(KeyCode.Return))
                {
                    ...
                    label.text = "Crap! 200 golds... It's an error... Alright, at least, you can now place your turret."
					+ "";//tuto_11
                }
                break;
            case 12:
                if (game.masterClient.gold < 200)
                {
                    ...
                    PhotonNetwork.InstantiateSceneObject("Ennemy0", gameObject.transform.position, Quaternion.identity, 0, new object[] { });
                    PhotonNetwork.InstantiateSceneObject("Ennemy0", gameObject.transform.position, Quaternion.identity, 0, new object[] { });
                    label.text = "Shit ! I can't explain without being disturbed ! Kill them !";//tuto_12
                }
                break;
            case 13:
                if (!game.ennemyInMap)
            ...
            case 14:
                ...
                {
                    i++;
                    label.text = "Perfect, now click a turret you have, and upgrade it !";//tuto_14
                }
                break;
            case 15:
            ...
            case 16:
                if (game.masterClient.MyUI.boutikScript.WeaponsSel)
                {
                    ...
                    label.text = "Here, you can buy weapons. In the game, switch with the mouse scroll wheel." +
                        ...
                        "\nPress [99ff00]Enter[-] to continue.";//tuto_16
                }
                break;
            case 17:
                if (Input.GetKeyDown(KeyCode.Return))
                {
                    i++;
				label.text = "Remember that in [99ff00] Elves Must Live [-], victory comes " +
					"from symbiosis with your turrets. Be as effective as they are on the battlefield and " +
					"the growing orcs waves will never resist you!"; //tuto_17 #Nat
                }
                break;
		case 18:
			if (Input.GetKeyDown (KeyCode.Return)) {
